...
2. Duplicate the qmd and rename it a05.qmd, which you will edit
...
5. You also need an introduction, motivatin the analysis, and a discussion, commenting on the images. 
6. "Render" the `qmd`. You will upload the html along with other files to your GitHub repo.
