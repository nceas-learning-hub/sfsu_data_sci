...
Congrats! Now you've setup your authentication you should be able to work with GitHub in RStudio no

## To join the GitHub Classroom, use this link:
...
-   Create assignment
    ...
    -   If first assigment, edit assignments/a01.qmd

    -   Else, in RStudio, File → New File → Quarto Document (or R Markdown)

    -   Save is as a0\*.qmd in the assignments/ folder

-   Commit your changes with a meaningful message

    -   In the Git tab, check the box next to assignments/a0\*.qmd

    -   Click "Commit"

    -   Write a commit message (e.g. "Add assignnmnt a03")
...
That's it! RStudio's Git integration makes this more straightforward once you get the hang of it. We'll discuss what these steps really mean next week. Also we’ll use merge (not rebase) as the default strategy.
