...
1.  Make sure you are in your `import-template-{USERNAME}` project
...
6.  Open your web browser to the [github.com](https://github.com/) and navigate to the page for your `import-template-{USERNAME}` repository
