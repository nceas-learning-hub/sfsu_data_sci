...
5. Name your repo something different than your assignments repo, owned by your instructors

6. Now we will make your repo public, so that GitHub pages will host your portfolio

7.  Open your web browser to the [github.com](https://github.com/) and navigate to the page for your newly cloned repository

8.  Activate GitHub Pages for the `main` branch
...
2.  Find and open `index.qmd`. If you don't find it, add a new Quarto file at the top level called `index.qmd`
...
Quarto web pages are a great way to share work in progress with your colleagues.
