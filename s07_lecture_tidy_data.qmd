...
::: callout-tip
## Make a quarto document to examime YOUR research data (or someone else's)

-   In RStudio, create a new branch called a02
-   In the assignments folder, create a new assignment called a02.qmd
-   Make sure your data is in the data/raw or data/processed folder in your R project
-   Create a quarto document that examines whether or not your data is tidy
-   Your document needs a title (and your name and date) and the following sections: Introduction, Data (where you import the data and view it, to see if it is tidy), Analysis (where you comment on whether or not it is tidy and if it has primary and foreign keys), Conclusion (a short summary)
-   Follow the instructions from chapter Quarto Literate Analysis, to commit and push (the qmd and html) from RStudio, and submit a Pull Request from your GitHub classroom repository when you have completed your assignment.
:::
