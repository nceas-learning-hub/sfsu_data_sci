...
To give you the skills to set up R, RStudio, and git environments, we will spend some time to make sure everyone has the three components integrated on their own laptop.
